...
So during a deployment a cluster of machines are attached to the defined namespaces in kubernetes.
...
This is optional, but the addons to be added to our cluster will be CoreDNS and PrometheusOperator that collects the metrics of the running pods using labels.
